...
export const Login = ({ toggle, settoggle }) => {
  ...
  let funn = async () => {
    ...
    console.log(value);
    axios
      .post("https://tata-1mg.onrender.com/login", value)
      .then((val) => {
        console.log(val);
          ...
          {st == true ? (
            <div className="inner-body">
              <div>
                ...
                <span className="style_text__2naEQ">
                  <span>
                    Provide Password sent to{info}
                    <button
                      onClick={() => setst(false)}
                      style={{ color: "#ff6f61" }}
                    >
              ...
              <div className="style_wrapper__EMT3C ">
                <label className="style_input-label__1kYYX"> password</label>
                <div className="style_input-wrapper__3kd0w">
                  <input
                    onChange={(e) => {
                      setpassword(e.target.value);
                    }}
                    className="style_input__3NmkT"
                  />
                </div>
              </div>
              <div
              ...
              <div className="innertwo">
                ...
                <div className="style_bottom-content_FTTVN">
                  <div className="stylefh-40_C40iw">
                    <span className="styletext_3XOlZ styletext-larger_2DsZQ styled-f_25FFn"></span>
                    <div className="styletext_3XOlZ styletext-lighter_2G_Vn styletext-small_2Rh34 styletnc-wrapper_3iYER">
                      <div>
                        <a href="/tnc"></a> <a href="/privacypolicy"></a>
                      </div>
                    </div>
                  </div>
                  <div className="stylebottom-content_FTTVN">
                    <div className="stylefh-20_1-IuS"></div>
                    <div className="stylelink_rBZIG styletnc-wrapper__3iYER">
            ...
            <div className="inner-body">
              ...
              <div className="style_wrapper__EMT3C ">
                <label className="style_input-label__1kYYX">
              ...
              <div className="innertwo">
                ...
                <div className="style_bottom-content_FTTVN">
                  <div className="stylefh-40_C40iw">
                    <span className="styletext_3XOlZ styletext-larger_2DsZQ styled-f_25FFn">
                      <span>
                        <span>New on 1mg? </span>
                        <span className="stylelink_rBZIG">Sign Up</span>
                      </span>
                    </span>
                    <div className="styletext_3XOlZ styletext-lighter_2G_Vn styletext-small_2Rh34 styletnc-wrapper_3iYER">
                      ...
                      <div>
                        <a href="/tnc">
                          <span className="styletnc_3w0N1">
                            Terms and Conditions
                          </span>
                        </a>{" "}
                        &amp;{" "}
                        <a href="/privacypolicy">
                          <span className="styletnc_3w0N1">Privacy Policy</span>
                        </a>
                      </div>
                    </div>
                  </div>
