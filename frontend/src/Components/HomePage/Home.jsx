  ...
  return (
   ...
   <SwiperSlide className='swiper_slide_2'>
    ...
    >
      ...
      {tata_1mg && tata_1mg.slice(0,10).map((elem)=>(
         ...
         <div className='Healthvit_heading'>
          ...
          <Text fontSize='12px' color={'#757575'}> {elem.shortDesc}</Text>
          ...
          <div>
           <Heading fontSize={'16px'} marginLeft={'10px'}>{elem.price}</Heading>
          </div>
          </Link>
       </SwiperSlide>
    ...
    >
      ...
      <Accordion defaultIndex={[0]} allowMultiple width={'80%'} margin={'auto'} padding="20px">
  <AccordionItem>
    <h2>
      <AccordionButton>
